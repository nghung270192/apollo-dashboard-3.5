...
export class Lwm2mObserveAttrTelemetryComponent implements ControlValueAccessor, OnDestroy, Validator {
  ...
  trackByParams = (index: number, objectLwM2M: ObjectLwM2M): number => objectLwM2M.id;
  ...
  getNameObject = (objectLwM2M: ObjectLwM2M): string => `${objectLwM2M.name} #${objectLwM2M.keyId}`;
}
