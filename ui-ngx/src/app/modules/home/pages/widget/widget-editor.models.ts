...
const widgetEditorCompletions: TbEditorCompletions = {
  ... {self: {
    ...
    type: '<a href="https://github.com/thingsboard/thingsboard/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/modules/home/ble-sigmesh/widget-component.ble-sigmesh.ts#L350">WidgetTypeInstance</a>',
    meta: 'object',
    children: {
      ...{
        onInit: {
        ...
        onDataUpdated: {
          description: 'Called when the new data is available from the widget subscription.<br>Latest data can be accessed from ' +
            'the <code>defaultSubscription</code> property of <a href="https://github.com/thingsboard/thingsboard/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/modules/home/ble-sigmesh/widget-component.ble-sigmesh.ts#L83">widget context (<code>ctx</code>)</a>.',
          meta: 'function'
        },
        onResize: {
          description: 'Called when widget container is resized. Latest <code>width</code> and <code>height</code> can be obtained from <a href="https://github.com/thingsboard/thingsboard/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/modules/home/ble-sigmesh/widget-component.ble-sigmesh.ts#L83">widget context (<code>ctx</code>)</a>.',
          meta: 'function'
        },
        onEditModeChanged: {
        ...
        getSettingsSchema: {
          description: 'Optional function returning widget settings schema json as alternative to <b>Settings tab</b> of <a href="https://smart.dienquang.com/docs/user-guide/contribution/widgets-development/#settings-schema-section">Settings schema section</a>.',
          meta: 'function',
          return: {
        ...
        getDataKeySettingsSchema: {
          description: 'Optional function returning particular data key settings schema json as alternative to <b>Data key settings schema</b> of <a href="https://smart.dienquang.com/docs/user-guide/contribution/widgets-development/#settings-schema-section">Settings schema section</a>.',
          meta: 'function',
          return: {
        ...
        typeParameters: {
          ...
          return: {
            ...
            type: '<a href="https://github.com/thingsboard/thingsboard/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/ble-sigmesh/widget.ble-sigmesh.ts#L146">WidgetTypeParameters</a>'
          }
        },
        actionSources: {
          ...
          return: {
            ...
            type: '{[actionSourceId: string]: <a href="https://github.com/thingsboard/thingsboard/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/ble-sigmesh/widget.ble-sigmesh.ts#L118">WidgetActionSource</a>}'
          }
        }
      },
