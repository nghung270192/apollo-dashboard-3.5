...
} from '@modules/apollo/widget/smart-dashboard-v2/models/zigbee/sub-devices/lumi.remote.b1acn01.model';
import {
  LumiRemoteB286acn01Model
} from '@modules/apollo/widget/smart-dashboard-v2/models/zigbee/sub-devices/lumi.remote.b286acn01.model';
import {
  LumiSensorMotionAq2Model
} from '@modules/apollo/widget/smart-dashboard-v2/models/zigbee/sub-devices/lumi.sensor.motion.aq2.model';
import {
  LumiSensorWleakAq1Model
} from '@modules/apollo/widget/smart-dashboard-v2/models/zigbee/sub-devices/lumi.sensor.wleak.aq1.model';
import {LumiWeatherModel} from '@modules/apollo/widget/smart-dashboard-v2/models/zigbee/sub-devices/lumi.weather.model';
...
import {DqhomeRe3} from '@modules/apollo/widget/smart-dashboard-v2/models/zigbee/sub-devices/dqhome.re3';
import {DqhomeRe6} from '@modules/apollo/widget/smart-dashboard-v2/models/zigbee/sub-devices/dqhome.re6';
import {DqhomeRe4} from '@modules/apollo/widget/smart-dashboard-v2/models/zigbee/sub-devices/dqhome.re4';
import {DqhomeRe1} from '@modules/apollo/widget/smart-dashboard-v2/models/zigbee/sub-devices/dqhome.re1';
import {DqhomeRe2} from '@modules/apollo/widget/smart-dashboard-v2/models/zigbee/sub-devices/dqhome.re2';


export class ZigbeeControllerProvider {
