...
import {HubParamsSource} from '@modules/apollo/widget/smart-dashboard-v1/models/hub/hub.model';
...
import {ApolloNodeTreeService} from '@modules/apollo/widget/smart-dashboard-v1/services/apollo-node-tree.service';
import {MainModule} from '@modules/apollo/widget/smart-dashboard-v1/component/main-page/main.module';
import {HubComponent} from '@modules/apollo/widget/smart-dashboard-v1/component/share/hub/hub.component';
...
export class HubConfigResolver {
  ...
  config: ApolloEntityConfig<NodeTree, HubParamsSource, NodeTree> = new ApolloEntityConfig<NodeTree, HubParamsSource, NodeTree>();

  constructor(private store: Store<AppState>,
              private apolloNodeTreeService: ApolloNodeTreeService) {
    this.config.entityComponent = HubComponent;
