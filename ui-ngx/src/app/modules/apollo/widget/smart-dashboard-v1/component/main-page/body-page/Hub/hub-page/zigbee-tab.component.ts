...
import {ZigbeeUpdateDeviceComponent} from '@modules/apollo/widget/smart-dashboard-v1/component/main-page/body-page/Hub/hub-page/zigbee-update-device.component';
