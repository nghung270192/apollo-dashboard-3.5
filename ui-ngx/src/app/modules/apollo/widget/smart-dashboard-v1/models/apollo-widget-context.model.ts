...
import {HubService} from '@modules/apollo/widget/smart-dashboard-v1/services/hub.service';
...
import {HomeAssistantGateway} from '@modules/apollo/widget/smart-dashboard-v1/models/dqsmart/home-assistant.model';
import {HubController} from '@modules/apollo/widget/smart-dashboard-v1/models/apollo-hub/apollo-hub';
import {ApolloService} from '@modules/apollo/widget/smart-dashboard-v1/services/apollo.service';
...
export interface TelemetryIncoming {
  ...
  time?: number;
  model?: DataKey;
  data?: [{ method: ResponseMethod; params: any }];
}
    ...
    if (data && Array.isArray(data)) {
      ...
      for (const dt of data) {
        const ds: TelemetryIncoming = {
          ...
          time: dt.data[0][0],
          model: dt.dataKey?.name as DataKey,
