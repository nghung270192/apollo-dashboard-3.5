...
export class OutputScriptImpl implements OutputScript {
  ...
  constructor(outputScript: OutputScript) {
...
export interface AutomationInfo extends SchedulerInfo {
  id?: string;
  enable?: boolean;
...
export interface TbDeviceId extends AutomationInfo {
  tbDeviceId?: DeviceId;
  hubNodeTreeId?: ApolloNodeTreeId;
}
...
export type NodeTreeInfoBase = HubInfo & IconInfo & GroupInfor & ZigbeeNodeTreeInfoBase;
