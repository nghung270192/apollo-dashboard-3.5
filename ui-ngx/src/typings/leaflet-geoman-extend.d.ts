...
declare module 'leaflet-pm' {
  ...
  namespace PM {
    ...
    interface PMLayerGroup {
      ...
      /** Returns the layers of the LayerGroup. `deep=true` return also the device-type of LayerGroup device-type. */
      ...
      /** Apply Leaflet-Geoman options to all device-type. The passed options are preserved, even when the mode is enabled via the Toolbar */
      setOptions(options?: EditModeOptions): void;
